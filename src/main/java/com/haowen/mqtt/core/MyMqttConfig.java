...
public class MyMqttConfig implements Serializable,Cloneable {
	...
	private boolean isLogMessageArrived=false;
	private boolean isLogMessageArrivedBody=false;
	//-------------------------------------
	private String bytereaderClassimpl;
	
	//---last will-----------------------
	private String lastWillTopic;
	private Integer lastWillTopicQos;
	private String lastWillTopicContent;
	private Boolean lastWillTopicRetain;
	...
	public String getBytereaderClassimpl() {
		return bytereaderClassimpl;
	}

	public void setBytereaderClassimpl(String bytereaderClassimpl) {
		this.bytereaderClassimpl = bytereaderClassimpl;
	}
	...
	public String toString() {
		return "MyMqttConfig [mqttUrl=" + mqttUrl + ", mqttUser=" + mqttUser + ", mqttpw=" + mqttpw + ", useAuth="
				...
				+ isLogMessageArrived + ", isLogMessageArrivedBody=" + isLogMessageArrivedBody + ", lastWillTopic="
				+ lastWillTopic + ", lastWillTopicQos=" + lastWillTopicQos + ", lastWillTopicContent="
				+ lastWillTopicContent + "]";
	}
	...
	public Integer getLastWillTopicQos() {
		return lastWillTopicQos;
	}

	public void setLastWillTopicQos(Integer lastWillTopicQos) {
		this.lastWillTopicQos = lastWillTopicQos;
	}

	public String getLastWillTopicContent() {
		return lastWillTopicContent;
	}

	public void setLastWillTopicContent(String lastWillTopicContent) {
		this.lastWillTopicContent = lastWillTopicContent;
	}

	public Boolean getLastWillTopicRetain() {
		return lastWillTopicRetain;
	}

	public void setLastWillTopicRetain(Boolean lastWillTopicRetain) {
		this.lastWillTopicRetain = lastWillTopicRetain;
	}
